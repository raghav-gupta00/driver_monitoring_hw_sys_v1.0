...
const char* ssid     = "SamsungA10";   //your network SSID
const char* password = "raghu007";   //your network password
int INPpin = 13;
int state = LOW;
String myScript = "/macros/s/AKfycbxIzuQWS1--sRtp3V8yB6puZnB9wrXImhReTqJWlOlEOPfEjq2kM8_ZqT4nEeKOl4GA/exec";    //Create your Google Apps Script and replace the "myScript" path.
